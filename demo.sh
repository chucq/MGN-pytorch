...
CUDA_VISIBLE_DEVICES=1,2,5,6 python main.py --num_classes 1501 --datadir ./dataset/Market-1501-v15.09.15/ --batchid 16 --batchtest 16 --test_every 50 --epochs 602 --decay_type step_320_380 --loss 1*CrossEntropy+2*Triplet --margin 1.2 --save adam_all --nGPU 4  --lr 2e-4 --optimizer ADAM --random_erasing --reset --re_rank --amsgrad
